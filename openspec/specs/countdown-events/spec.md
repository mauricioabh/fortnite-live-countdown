...
Events dashboard and API show only real-dated Fortnite milestones (including shop rotation) with live countdowns; BR MOTD / news rows are excluded and belong to the News capability.
