...
| `/offline`                  | Offline (PWA)    | Fallback cuando no hay red; el SW sirve esta página en producción                                              | Público                                                        |
| `manifest.webmanifest`      | —                | Web App Manifest (`standalone`) para instalar en home screen                                                   | Público                                                        |
