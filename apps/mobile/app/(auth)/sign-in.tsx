...
export default function SignInScreen() {
  ...
  const onEmailSignIn = async () => {
    ...
    try {
      ...
      setErr("Complete the Clerk flow (verification or second factor).");
    } catch (e: unknown) {
      const msg =
  ...
  return (
    <View style={styles.wrap}>
      ...
      >
        {busy ? <ActivityIndicator color={colors.primaryForeground} /> : <Text style={styles.btnPrimaryText}>Sign in</Text>}
      </Pressable>
      <Pressable
...
const styles = StyleSheet.create({
  ...
  title: { color: colors.foreground, fontSize: 22, fontWeight: "700", marginBottom: 8 },
  input: {
    borderWidth: 1,
